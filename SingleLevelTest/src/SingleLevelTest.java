...
public class SingleLevelTest {
	public static void main(String[] args) {
		...
		ShapeOfPoint sp = new ShapeOfPoint(88, 99, 45, "Green", "Square");
		sp.showPoint();
	}
}
...
class ShapeOfPoint extends ColouredPoint3D
{
	private String shape;
	
	public ShapeOfPoint(int x, int y, int z, String color, String shape) {
		super(x,y,z,color);
		this.shape = shape;
	}
